...
show_only_frames = [50, 53] # show only frames in interval for debugging
...
sequence = "1"
model_type = "darknet"
results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'results/' + model + '/results_sequence_' + sequence + '_' + model_type)
